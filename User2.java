...
class User2 {private String unitid, studid, name;private Date date;private Time timein, timeout; private int bookno;
public User2 (String unitid, String studid, String name,Date date, Time timein, Time timeout, int bookno){
